...
function renderMarkdown(text) { var h=escapeHtml(text); var nl=String.fromCharCode(10); var parts96=h.split(String.fromCharCode(96,96,96)); if(parts96.length>1){var code=String.fromCharCode(96,96,96);var open=String.fromCharCode(60,112,114,101,62,60,99,111,100,101,62);var close=String.fromCharCode(60,47,99,111,100,101,62,60,47,112,114,101,62);h=parts96.map(function(p,i){if(i%2===1){return open+p+close;}return p;}).join(String.fromCharCode(10));} var parts1=h.split(String.fromCharCode(96));h=parts1.map(function(p,i){if(i%2===1){return String.fromCharCode(60,99,111,100,101,62)+p+String.fromCharCode(60,47,99,111,100,101,62);}return p;}).join(String.fromCharCode(10));var partsB=h.split(String.fromCharCode(42,42));h=partsB.map(function(p,i){if(i%2===1){return String.fromCharCode(60,115,116,114,111,110,103,62)+p+String.fromCharCode(60,47,115,116,114,111,110,103,62);}return p;}).join(String.fromCharCode(10));var partsI=h.split(String.fromCharCode(42));h=partsI.map(function(p,i){if(i%2===1){return String.fromCharCode(60,101,109,62)+p+String.fromCharCode(60,47,101,109,62);}return p;}).join(String.fromCharCode(10));h=h.split(nl).join(String.fromCharCode(60,98,114,62));return h; }
