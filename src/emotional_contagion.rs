...
const POSITIVE_WORDS: &[&str] = &[
    "good", "great", "happy", "love", "joy", "wonderful", "excellent", "amazing",
    "beautiful", "success", "hope", "peace", "calm", "warm", "bright", "kind",
    "jó", "szép", "boldog", "öröm", "szeretet", "csodás", "remek", "siker",
];

const NEGATIVE_WORDS: &[&str] = &[
    "bad", "sad", "angry", "hate", "fear", "terrible", "awful", "pain",
    "dark", "fail", "loss", "cold", "broken", "wrong", "ugly", "hurt",
    "rossz", "szomorú", "fájdalom", "harag", "félelem", "kudarc", "sötét",
];
